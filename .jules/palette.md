...
## 2024-03-24 - Accessibility: Missing ARIA labels and alt text
**Learning:** Some inputs and icon-only buttons lacked aria-labels which are required for screen-reader accessibility.
**Action:** Added aria-labels to the inputs in the reset-password component and some buttons in the dashboard sections to improve accessibility.
