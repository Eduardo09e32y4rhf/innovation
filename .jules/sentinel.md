...
## 2026-06-17 - [NestJS Security Hardening]
**Vulnerability:** Default NestJS applications lack basic security middleware like rate limiting and HTTP header protection.
**Learning:** Implementing `helmet` and `@nestjs/throttler` is a foundational requirement for any production-ready API to mitigate common attacks like brute-forcing and XSS.
**Prevention:** Ensure all new project setups include mandatory security dependencies and proper configuration in the main application entry point.
