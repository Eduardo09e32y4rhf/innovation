...
export class DashboardRepository {
  ...
  private async buildInsights(employeeWhere: any, companyId: string) {
    ...
    // ⚡ Bolt: Optimized by consolidating 7 sequential .filter() passes into a single O(N) for...of loop.
    // This reduces redundant memory allocations and CPU cycles for large employee collections.
    let missingUser = 0;
