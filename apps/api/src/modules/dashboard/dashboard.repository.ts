...
export class DashboardRepository {
  ...
  private async buildInsights(employeeWhere: any, companyId: string) {
    ...
    const employeeIds = employees.map((employee: { id: string; name: string; birthDate: Date | null; admissionDate: Date | null; terminationDate: Date | null; status: string; userId: string | null; managerId: string | null; cpf: string | null; workScale: string | null; dailyWorkload: number | null }) => employee.id);
    ...
    const birthdaysToday = employees.filter((employee: { id: string; name: string; birthDate: Date | null; admissionDate: Date | null; terminationDate: Date | null; status: string; userId: string | null; managerId: string | null; cpf: string | null; workScale: string | null; dailyWorkload: number | null }) => employee.birthDate && employee.birthDate.getUTCMonth() + 1 === month && employee.birthDate.getUTCDate() === day).slice(0, 8);
    const birthdaysThisMonth = employees.filter((employee: { id: string; name: string; birthDate: Date | null; admissionDate: Date | null; terminationDate: Date | null; status: string; userId: string | null; managerId: string | null; cpf: string | null; workScale: string | null; dailyWorkload: number | null }) => employee.birthDate && employee.birthDate.getUTCMonth() + 1 === month).slice(0, 12);
    const missingUser = employees.filter((employee: { id: string; name: string; birthDate: Date | null; admissionDate: Date | null; terminationDate: Date | null; status: string; userId: string | null; managerId: string | null; cpf: string | null; workScale: string | null; dailyWorkload: number | null }) => employee.status === 'ACTIVE' && !employee.userId).length;
    const missingManager = employees.filter((employee: { id: string; name: string; birthDate: Date | null; admissionDate: Date | null; terminationDate: Date | null; status: string; userId: string | null; managerId: string | null; cpf: string | null; workScale: string | null; dailyWorkload: number | null }) => employee.status === 'ACTIVE' && !employee.managerId).length;
    const missingCpf = employees.filter((employee: { id: string; name: string; birthDate: Date | null; admissionDate: Date | null; terminationDate: Date | null; status: string; userId: string | null; managerId: string | null; cpf: string | null; workScale: string | null; dailyWorkload: number | null }) => !employee.cpf).length;
    const missingWorkScale = employees.filter((employee: { id: string; name: string; birthDate: Date | null; admissionDate: Date | null; terminationDate: Date | null; status: string; userId: string | null; managerId: string | null; cpf: string | null; workScale: string | null; dailyWorkload: number | null }) => employee.status === 'ACTIVE' && !employee.workScale).length;
    const missingWorkload = employees.filter((employee: { id: string; name: string; birthDate: Date | null; admissionDate: Date | null; terminationDate: Date | null; status: string; userId: string | null; managerId: string | null; cpf: string | null; workScale: string | null; dailyWorkload: number | null }) => employee.status === 'ACTIVE' && !employee.dailyWorkload).length;
    const company = await this.prisma.company.findUnique({ where: { id: companyId }, select: { name: true, document: true, logoUrl: true } });
    return {
      birthdaysToday: birthdaysToday.map((employee: { id: string; name: string; birthDate: Date | null; admissionDate: Date | null; terminationDate: Date | null; status: string; userId: string | null; managerId: string | null; cpf: string | null; workScale: string | null; dailyWorkload: number | null }) => ({ id: employee.id, name: employee.name, birthDate: employee.birthDate })),
      birthdaysThisMonth: birthdaysThisMonth.map((employee: { id: string; name: string; birthDate: Date | null; admissionDate: Date | null; terminationDate: Date | null; status: string; userId: string | null; managerId: string | null; cpf: string | null; workScale: string | null; dailyWorkload: number | null }) => ({ id: employee.id, name: employee.name, birthDate: employee.birthDate })),
