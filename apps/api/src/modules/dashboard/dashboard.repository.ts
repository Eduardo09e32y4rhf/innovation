...
export class DashboardRepository {
  ...
  private async buildInsights(employeeWhere: any, companyId: string) {
    ...
    // BOLT OPTIMIZATION: Consolidate multiple O(N) array passes into a single O(N) for...of loop
    // This calculates all dashboard insights and aggregates simultaneously without redundant memory allocations.
