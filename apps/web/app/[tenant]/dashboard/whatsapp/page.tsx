    ...
    <section className="grid grid-cols-1 gap-4 lg:grid-cols-3">
      <div className="ops-card rounded-[8px] border border-slaté-200 bg-white p-5 lg:col-span-1">
        ...
        <div className="mt-4 flex gap-2">
          ...
          <button aria-label="Atualizar conexões" onClick={onRefresh} className="btn-outline inline-flex h-10 w-10 items-center justify-center rounded-[8px]">
            <RefreshCw size={14} />
          </button>
        </div>
      </div>
    ...
    <div className={className || "flex min-h-0 flex-col border-b border-slaté-200 md:border-b-0 md:border-r"}>
      ...
      <div className="flex h-[59px] shrink-0 items-center justify-between bg-[#f0f2f5] px-4">
        ...
        <div className="flex items-center gap-4 text-[#54656f]">
          <button aria-label="Atualizar mensagens" onClick={onRefresh} className="hover:text-[var(--color-brand)] transition" title="Atualizar">
            <RefreshCw size={20} />
          </button>
        </div>
      </div>
  ...
  return (
    <div className={className || "flex min-h-0 flex-1 flex-col relative"}>
      ...
      <div className="flex h-[59px] shrink-0 items-center gap-3 bg-[#f0f2f5] px-4">
        <button aria-label="Voltar para lista de conversas" onClick={onBack} className="md:hidden flex h-10 w-10 shrink-0 items-center justify-center rounded-full text-[#54656f] hover:bg-black/5">
      ...
      <div className="flex shrink-0 items-center gap-3 bg-[#f0f2f5] px-4 py-2 min-h-[62px]">
        ...
        <button aria-label="Adicionar emoji" className="text-[#54656f] hover:text-[#111b21] transition">
        ...
        <div className="flex-1 bg-white rounded-lg flex items-center shadow-sm relative">
          {attachment && (
            <div className="absolute bottom-[110%] left-0 z-10 flex items-center gap-3 rounded-lg bg-white p-3 shadow-md border border-slaté-200">
              ...
              <button aria-label="Remover anexo" onClick={() => setAttachment(null)} className="flex h-6 w-6 items-center justify-center rounded-full bg-slaté-100 text-slaté-500 hover:bg-rose-100 hover:text-rose-600">
