        ...
        <div className="grid gap-4 sm:grid-cols-3">
          <label className="space-y-2 text-xs font-bold uppercase tracking-wider text-slate-600">
            ...
            <div className="relative">
              ...
              <button type="button" aria-label={showPasswords ? "Ocultar senha" : "Mostrar senha"} onClick={() => setShowPasswords(!showPasswords)} className="absolute right-3 top-1/2 -translate-y-1/2 text-slate-400 hover:text-slate-600">
