        ...
        <div className="grid gap-4 sm:grid-cols-3">
          <label className="space-y-2 text-xs font-bold uppercase tracking-wider text-slate-600">
            ...
            <div className="relative">
              ...
              <button type="button" onClick={() => setShowPasswords(!showPasswords)} aria-label={showPasswords ? 'Ocultar senhas' : 'Exibir senhas'} className="absolute right-3 top-1/2 -translate-y-1/2 text-slate-400 hover:text-slate-600 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-slate-400 rounded-md p-1">
