  ...
  return (
    <div className="flex flex-col items-center justify-center gap-3 rounded-[8px] border border-rose-200 bg-rose-50 py-14 text-center">
      ...
      {onRetry && (
        <button
          onClick={onRetry}
          className="mt-1 inline-flex items-center gap-2 rounded-[8px] border border-rose-300 bg-white px-4 py-2 text-xs font-bold text-rose-600 transition hover:bg-rose-100"
        >
