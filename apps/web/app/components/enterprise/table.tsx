...
export function DownloadPdfButton({ onClick, ariaLabel = "Baixar PDF", title = "Baixar PDF" }: { onClick?: () => void, ariaLabel?: string, title?: string }) {
  return (
    <TableActionButton onClick={onClick} ariaLabel={ariaLabel} title={title}>
      <Download size={14} />
    </TableActionButton>
  );
}
