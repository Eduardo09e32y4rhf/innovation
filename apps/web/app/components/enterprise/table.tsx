...
export function TableActionButton({
  ...
  return (
    <button
      onClick={onClick}
      className="p-2 bg-white/5 rounded-lg hover:text-purple-400 transition-colors focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-purple-400"
      type="button"
      aria-label={ariaLabel}
      title={title}
    >
