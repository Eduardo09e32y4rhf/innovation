...
export function TableActionButton({
  ...
  return (
    <button
      onClick={onClick}
      className="p-2 bg-white/5 rounded-lg hover:text-purple-400 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-current"
      type="button"
      aria-label={ariaLabel}
      title={title}
    >
