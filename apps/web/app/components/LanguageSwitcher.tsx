  ...
  return (
    <div className="relative">
      <button
        ...
        className="flex items-center gap-2 px-4 py-2 rounded-lg bg-white/5 border border-white/10 hover:bg-white/10 transition-all text-sm focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-purple-500"
      >
        <Globe size={16} />
