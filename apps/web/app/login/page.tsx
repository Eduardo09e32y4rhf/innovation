...
export default function LoginPage() {
  ...
  const { login, logout, loading, error, isAuthenticated, company, user } =
    useAuth();
  ...
  useEffect(() => {
    ...
    if (didSubmit && isAuthenticated && company) {
      ...
      router.push(
        mustPay
          ? `/${slug}/fatura-pendente?autoCheckout=1`
          : `/${slug}/dashboard`,
      );
    }
      ...
      <form onSubmit={handleLogin} className="flex flex-col gap-5">
        ...
        <div className="mt-6 flex flex-col items-center border-t border-zinc-100 pt-4">
          <div className="relative">
            ...
            >
              <span className="flex h-5 w-5 items-center justify-center rounded-full bg-[var(--color-brand)] text-white font-black text-[11px]">
                !
              </span>
              ...
              <div className="absolute bottom-11 left-1/2 -translate-x-1/2 w-64 surface p-2 z-50 animate-in fade-in zoom-in duration-200">
                ...
                <button
                  ...
                  onClick={() => {
                    ...
                    router.push(
                      "/suporte?category=LOGIN_ISSUE&subject=Não%20consigo%20entrar",
                    );
                  }}
                ...
                <button
                  ...
                  onClick={() => {
                    setShowHelpMenu(false);
                    router.push(
                      "/suporte?category=BUG&subject=Erro%20na%20página",
                    );
                  }}
                  className="flex w-full items-center gap-2.5 rounded-[var(--radius-sm)] px-3 py-2 text-left text-xs font-semibold text-zinc-700 hover:bg-zinc-50 transition-colors"
                >
                ...
                <button
                  ...
                  onClick={() => {
                    setShowHelpMenu(false);
                    router.push(
                      "/suporte?category=PERFORMANCE&subject=Sistema%20indisponível",
                    );
                  }}
                  className="flex w-full items-center gap-2.5 rounded-[var(--radius-sm)] px-3 py-2 text-left text-xs font-semibold text-zinc-700 hover:bg-zinc-50 transition-colors"
                >
                ...
                <button
                  ...
                  onClick={() => {
                    setShowHelpMenu(false);
                    router.push(
                      "/suporte?category=OTHER&subject=Outro%20problema",
                    );
                  }}
                  className="flex w-full items-center gap-2.5 rounded-[var(--radius-sm)] px-3 py-2 text-left text-xs font-semibold text-zinc-700 hover:bg-zinc-50 transition-colors"
                >
