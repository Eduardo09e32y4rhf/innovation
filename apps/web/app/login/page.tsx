            ...
            {!forgotPassword && (
              <div className="group relative">
                ...
                <button
                  ...
                  className="absolute inset-y-0 right-0 flex items-center pr-4 text-slate-500 hover:text-white transition-colors focus:outline-none rounded-r-xl focus-visible:ring-2 focus-visible:ring-teal-500 focus-visible:ring-inset"
