...
<div className="max-w-6xl mx-auto animate-in fade-in duration-700">
        <header className="mb-10">
          ...
          <p className="text-gray-400">Acompanhe a eficiência do seu funil de contratação e performance da IA.</p>
        </header>

        {/* Top Cards */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
          <StatCard title="Total de Candidatos" value="1,284" change="+12%" icon={<Users />} positive={true} />
          <StatCard title="Média AI Score" value="82.4" change="+5.2%" icon={<Target />} positive={true} />
          <StatCard title="Taxa de Conversão" value="14.2%" change="-2.1%" icon={<TrendingUp />} positive={false} />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 glass p-8 rounded-3xl">
            <div className="flex items-center justify-between mb-8">
              ...
              <select className="bg-white/5 border border-white/10 rounded-lg px-3 py-1 text-xs outline-none">
                <option>�altimos 30 dias</option>
                <option>�altimos 7 dias</option>
              </select>
            </div>
            ...
            <div className="space-y-6">
              ...
              <FunnelStep label="Contratações" value="18" percent="1.4%" color="bg-green-500" />
            </div>
          </div>
          ...
          <div className="lg:col-span-1 glass p-8 rounded-3xl">
            ...
            <div className="space-y-6">
              ...
              <SourceItem name="Indicação" value="184" />
              <SourceItem name="Orgânico" value="120" />
            </div>
            ...
            <div className="mt-10 p-4 rounded-2xl bg-purple-500/10 border border-purple-500/20 text-center">
              ...
              <p className="text-[10px] text-gray-400">O LinkedIn está trazendo os candidatos com maior AI Score (média 88).</p>
            </div>
          </div>
        </div>
      </div>
