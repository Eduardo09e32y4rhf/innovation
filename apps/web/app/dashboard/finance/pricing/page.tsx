...
<div className="max-w-6xl mx-auto py-10 animate-in fade-in zoom-in duration-700">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-400 max-w-2xl mx-auto">Scale seu recrutamento com inteligencia artificial. Sem taxas ocultas, cancele quando quiser.</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <PricingCard
            ...
            features={['5 Vagas Ativas', 'Analise IA Basica', '1 Usuario', 'Suporte via Chat']}
          ...
          <div className="relative">
            ...
            <PricingCard
              ...
              features={['Vagas Ilimitadas', 'Analise IA Avancada', '5 Usuarios', 'Integracao WhatsApp', 'Dashboard Analytics']}
              highlight={true}
          ...
          <PricingCard
            title="Enterprise"
            price="499"
            desc="Solucao completa customizada."
...
const PricingCard = ({ title, price, desc, features, highlight = false, icon }: { title: string; price: string; desc: string; features: string[]; highlight?: boolean; icon: React.ReactNode }) => (
