  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <button
        ...
        className="relative inline-flex h-10 w-10 items-center justify-center rounded-[8px] border border-slate-200 bg-white text-slate-700 transition-all hover:border-teal-500 hover:text-teal-700 focus-visible:ring-2 focus-visible:ring-purple-400 focus-visible:outline-none"
        ...
        <div className="absolute right-0 top-[110%] z-[99999] w-[360px] max-w-[calc(100vw-2rem)] overflow-hidden rounded-[12px] border border-slate-200 bg-white shadow-[0_20px_50px_rgba(15,23,42,0.18)]">
          <div className="flex items-center justify-between border-b border-slate-100 px-4 py-3">
            ...
            <div className="flex gap-1.5">
              ...
              <button type="button" onClick={() => setOpen(false)} className="text-slate-400 hover:text-slate-700 focus-visible:ring-2 focus-visible:ring-purple-400 focus-visible:outline-none rounded-sm" aria-label="Fechar notificações">
