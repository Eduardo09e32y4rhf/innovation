        ...
        <div className="group relative">
          ...
          <button
            ...
            onClick={() => setShowPassword(!showPassword)}
              ...
              className="absolute inset-y-0 right-0 flex w-12 items-center justify-center text-slate-400 hover:text-slate-600 focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-500 focus-visible:ring-inset rounded-r-[14px]"
          >
