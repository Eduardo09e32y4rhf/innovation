            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="group relative col-span-1 md:col-span-2">
                ...
                <button
                  ...
                  className="absolute inset-y-0 right-0 flex items-center pr-4 text-slate-500 hover:text-white focus:outline-none focus-visible:ring-2 focus-visible:ring-teal-500 rounded-r-xl"
