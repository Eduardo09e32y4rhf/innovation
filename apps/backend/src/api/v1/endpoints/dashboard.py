...
async def get_kanban_board(
    ...
    # ⚡ Bolt: Fetch related job and candidate data in a single query to eliminate N+1 problem.
    # Why: Previously executed 2 separate database queries for each application inside the loop.
