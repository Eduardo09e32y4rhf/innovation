        ...
        <div className={`fixed top-0 left-0 right-0 z-[100] ${style.bg} ${style.border} border-b backdrop-blur-xl`}>
            <div className="max-w-7xl mx-auto px-4 py-2.5 flex items-center justify-center gap-3">
                ...
                <button
                    ...
                    className="text-slate-900/60 hover:text-slate-900 transition ml-2 shrink-0 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 rounded"
