          ...
          {keys.map((k) => (
            ...
            >
              ...
              <button
                ...
                className="p-2 rounded-lg bg-red-500/0 hover:bg-red-500/10 text-red-500/40 hover:text-red-500 transition-all focus-visible:ring-2 focus-visible:ring-red-500 focus-visible:outline-none"
