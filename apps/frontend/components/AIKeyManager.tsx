  ...
  return (
    ...
    >
      <div className="flex items-center justify-between mb-8">
        ...
        <button
          onClick={handleReset}
          aria-label="Resetar Status"
          title="Resetar Status"
          className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-white/5 border border-white/10 text-[10px] font-black text-slate-900/60 hover:bg-white/10 hover:text-slate-900 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 transition-all uppercase"
        >
          ...
          {keys.map((k) => (
            ...
            >
              ...
              <button
                ...
                title="Remover chave"
                className="p-2 rounded-lg bg-red-500/0 hover:bg-red-500/10 text-red-500/40 hover:text-red-500 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-500 transition-all"
              >
