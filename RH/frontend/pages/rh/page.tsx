...
import { Employee, PipelineStage, STAGE_LABELS } from './rh-types';
import { PipelineMoveRequest } from './rh-types';

// Regras de transição vindas do backend pipeline_api.py
...
function AdmissionModal({ isOpen, onClose }: { isOpen: boolean; onClose: () => void }) {
    ...
    const handleSend = async () => {
        ...
        try {
            ...
            console.error("Erro na admissão:", e);
            alert("Falha ao enviar convite. Verifique o e-mail e tente novamente.");
        }
