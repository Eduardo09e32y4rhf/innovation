                        ...
                        {activeTab === 'costs' && (
                            <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -10 }} key="costs">
                                <div className="flex items-center justify-between mb-10">
                                    ...
                                    {costCenters && (
                                        <div className="bg-emerald-50 text-emerald-600 px-6 py-2 rounded-2xl border border-emerald-100 font-black text-xs">
                                ...
                                {costCenters ? (
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                        ...
                                        <div className="flex items-center justify-center p-10 bg-slate-50 rounded-[2rem] border border-dashed border-slate-200">
