...
export default function InsightsPage() {
            ...
            <AppLayout title="Inteligência & Insights">
                <div className="flex items-center justify-center min-h-[60vh]">
                    <div className="text-center">
                        ...
                        <p className="text-slate-500 font-medium">Sincronizando modelos de IA...</p>
                    </div>
                </div>
            </AppLayout>
        );
    ...
    return (
        <AppLayout title="Inteligência & Insights">
            <div className="min-h-screen bg-white text-slate-900 p-4 sm:p-8 relative overflow-hidden">
                {/* Background Decorations */}
                <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-blue-500/10 rounded-full blur-[120px] -z-10 translate-x-1/2 -translate-y-1/2" />
                    ...
                    <div className="bg-white border border-slate-200 rounded-[2.5rem] p-8">
                        <div className="flex items-center justify-between mb-8">
                            <div>
                                ...
                                <p className="text-xs text-slate-500 mt-1 uppercase tracking-widest font-bold">Projeção trimestral 2026</p>
                            </div>
                        ...
                        <div className="h-[200px] flex items-end gap-2 md:gap-4">
                            {[45, 60, 55, 80, 70, 90, 85, 95, 100, 92, 110, 115].map((val, i) => (
                                <div key={i} className="flex-1 flex flex-col items-center gap-2 group">
                                    ...
                                    <span className="text-[8px] text-slate-300 font-bold hidden md:block">SEM {i + 1}</span>
                                </div>
                            ))}
                        </div>
                    </div>
