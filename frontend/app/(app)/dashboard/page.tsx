        ...
        <div className="bg-white border border-slate-200 border-black/5 shadow-sm border border-slate-100 p-6 rounded-[2rem] shadow-sm hover:shadow-xl hover:shadow-indigo-100/40 transition-all group relative overflow-hidden">
            ...
            <div className="relative z-10">
                <div className="flex justify-between items-start mb-5">
                    <div className={`w-12 h-12 rounded-2xl flex items-center justify-center bg-white border border-slate-200 border-black/5 shadow-sm border border-slate-100 shadow-sm ${stat.colorClass.split(' ')[0].replace('from-', 'text-')}`}>
                        <Icon size={24} />
                    </div>
            ...
            <div className="p-8 space-y-10 animate-in fade-in duration-700">
                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                    ...
                    <div className="flex items-center gap-3">
                        <button onClick={() => setHidden(!hidden)} className="w-12 h-12 bg-white border border-slate-200 border-black/5 shadow-sm border border-slate-100 rounded-2xl flex items-center justify-center text-slate-400 hover:text-indigo-600 hover:border-indigo-200 transition-all shadow-sm">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
                    ...
                    <div className="lg:col-span-8 space-y-8">
                        ...
                        <div className="bg-white border border-slate-200 border-black/5 shadow-sm border border-slate-100 rounded-[2.5rem] p-8 shadow-sm space-y-2">
                            {loading ? (
                                ...
                                activities.slice(0, 6).map((item, i) => (
                                    <div key={i} className="flex items-center gap-5 p-5 rounded-2xl bg-white border border-slate-200 border-black/5 shadow-sm border border-transparent hover:border-slate-100 hover:bg-slate-50/50 transition-all group">
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="bg-indigo-600 rounded-[2.5rem] p-8 text-white shadow-xl shadow-indigo-100 relative overflow-hidden group">
                                ...
                                <div className="relative z-10 flex flex-col h-full justify-between gap-8">
                                    ...
                                    <Link href="/chat-ia" className="w-full bg-white border border-slate-200 border-black/5 shadow-sm text-indigo-600 py-4 rounded-[1.5rem] font-black text-center text-[10px] uppercase tracking-widest shadow-lg hover:scale-[1.02] transition-all">Iniciar Diálogo</Link>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    {metrics.most_frequented.map((feat: any, i: number) => {
                                        ...
                                        return (
                                            <div key={i} className="flex flex-col items-center gap-3 p-6 bg-white border border-slate-200 border-black/5 shadow-sm border border-slate-100 rounded-[2rem] hover:border-indigo-100 shadow-sm transition-all group">
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                {[
                                    ...
                                    return (
                                        <Link key={i} href={link.href} className="flex flex-col items-center gap-3 p-6 bg-white border border-slate-200 border-black/5 shadow-sm border border-slate-100 rounded-[2rem] hover:border-indigo-100 hover:shadow-lg hover:shadow-indigo-100/30 transition-all group">
                ...
                {user?.role === 'admin' && (
                    <div className="pt-8 border-t border-slate-100">
                        ...
                        <div className="bg-white border border-slate-200 border-black/5 shadow-sm border border-slate-100 rounded-[2.5rem] p-4 shadow-sm overflow-hidden">
                            <AIKeyManager />
                        </div>
                    </div>
                )}
