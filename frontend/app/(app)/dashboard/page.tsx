...
function StatCard({ stat, index }: { stat: any; index: number }) {
    ...
    return (
        <div
            className="group relative bg-white/[0.03] border border-purple-500/15 rounded-2xl p-5 hover:border-[#8b5cf6]/40 hover:bg-white/[0.05] transition-all duration-300 overflow-hidden"
            ...
            <div className="min-h-screen text-white">
                ...
                <div className="p-8 space-y-8">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        ...
                        {/* Ranking de Módulos */}
                        <div className="lg:col-span-1 bg-white/[0.03] border border-purple-500/15 rounded-2xl p-6">
                        ...
                        {/* Gráfico de Receita */}
                        <div className="lg:col-span-2 bg-white/[0.03] border border-purple-500/15 rounded-2xl p-6">
                            <div className="flex items-center justify-between mb-5">
                                <div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        ...
                        <div className="lg:col-span-2 bg-white/[0.03] border border-purple-500/15 rounded-2xl p-6">
                            ...
                            {/* Heatmap */}
                            <div className="mb-5 p-3 bg-white/[0.02] rounded-xl border border-purple-500/10">
                                ...
                                {loading ? (
                                    ...
                                    [
                                        ...
                                        <div key={i} className="flex items-center gap-3 group hover:bg-white/[0.02] px-2 py-1.5 rounded-xl transition-all">
                                            <div className="w-9 h-9 rounded-full bg-white/5 border border-purple-500/15 flex items-center justify-center text-base shrink-0">
                                                {item.badge}
                                            </div>
                                            <div className="flex-1 min-w-0">
                    ...
                    {/* ── QUICK ACCESS ─────────────────────────────────────────────── */}
                    <div>
                        <h2 className="text-sm font-bold text-white/40 uppercase tracking-widest mb-4">Acesso Rápido</h2>
                            ...
                            {[
                                ...
                                return (
                                    <Link key={i} href={item.href}
                                        className="flex flex-col items-center gap-2 p-4 bg-white/[0.03] border border-purple-500/15 rounded-2xl hover:border-[#8b5cf6]/40 hover:bg-white/[0.06] transition-all group">
                                        ...
                                        <span className="text-xs font-medium text-white/50 group-hover:text-white transition-colors">{item.label}</span>
                                    </Link>
                                );
                            })}
                        </div>
                    ...
                    {user?.role === 'admin' && (
                        <div>
                            <h2 className="text-sm font-bold text-white/40 uppercase tracking-widest mb-4">Administração de IA</h2>
                            <AIKeyManager />
                        </div>
                    )}
