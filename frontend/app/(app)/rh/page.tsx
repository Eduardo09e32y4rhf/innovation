    ...
    return (
        ...
        >
            ...
            <div className="flex-1 min-w-0">
                <h3 className="text-sm font-semibold text-slate-800 truncate group-hover:text-blue-600 transition-colors tracking-tight">{employee.name}</h3>
                <p className="text-[12px] text-slate-500 truncate mt-0.5">{employee.role} <span className="text-slate-700 mx-1">•</span> {employee.department}</p>
            </div>
                ...
                <>
                    ...
                    >
                        <div className="flex justify-between items-start mb-8">
                            ...
                            <button onClick={onClose} className="p-2 rounded-full bg-slate-50 hover:bg-slate-100 text-slate-400 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500" aria-label="Fechar detalhes" title="Fechar detalhes">
                                <X size={20} />
                            </button>
                        </div>
                        ...
                        <div className="bg-white border-slate-200 border-black/5 shadow-sm/70 backdrop-blur-xl border-slate-200/60 rounded-[2rem] p-6 sm:p-8 shadow-sm">
                            <div className="flex items-center justify-between mb-8">
                                ...
                                <div className="flex gap-1">
                                    ...
                                    <button className="p-2 text-slate-400 hover:text-blue-600 hover:bg-indigo-50 rounded-xl transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500" aria-label="Abrir quadro de colaboradores" title="Abrir quadro de colaboradores"><ArrowUpRight size={18} /></button>
                                </div>
                            </div>
