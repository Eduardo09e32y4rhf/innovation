                        ...
                        <div className="bg-white border-slate-200 border-black/5 shadow-sm/70 backdrop-blur-xl border-slate-200/60 rounded-[2rem] p-6 sm:p-8 shadow-sm">
                            <div className="flex items-center justify-between mb-8">
                                ...
                                <div className="flex gap-1">
                                    <button aria-label="Filtrar" className="p-2 text-slate-400 hover:text-blue-600 hover:bg-indigo-50 rounded-xl transition-colors"><Filter size={18} /></button>
                                    <button aria-label="Exportar" className="p-2 text-slate-400 hover:text-blue-600 hover:bg-indigo-50 rounded-xl transition-colors"><ArrowUpRight size={18} /></button>
                                </div>
                            </div>
