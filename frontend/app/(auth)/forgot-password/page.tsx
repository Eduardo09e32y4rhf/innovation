                    ...
                    <Card className="relative border-white/[0.08] bg-black/40 backdrop-blur-3xl rounded-[2rem] shadow-2xl overflow-hidden">
                        ...
                        <CardContent className="px-8 pb-8">
                            <form onSubmit={handleResetRequest} className="space-y-5">
                                ...
                                <Button
                                    className="w-full h-12 bg-white border border-slate-200 border-black/5 shadow-sm text-black hover:bg-zinc-200 rounded-2xl font-black text-xs uppercase tracking-[0.2em] transition-all relative overflow-hidden group shadow-xl shadow-white/5"
