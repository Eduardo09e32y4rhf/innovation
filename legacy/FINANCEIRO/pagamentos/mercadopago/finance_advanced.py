...
def get_cost_centers(
    ...
    # ⚡ Bolt Optimization: Switched to database-level aggregation using func.sum() and func.count()
    # to avoid loading all Transaction records into memory (O(1) memory instead of O(N))
    # and improve query performance significantly as data scales.
    results = (
        db.query(
