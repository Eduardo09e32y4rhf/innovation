...
test.describe('Innovation IA - Testes Exploratórios e Agressivos', () => {
  ...
  test('1. Fluxo Admin/RH - Cadastro e Notificacao', async ({ page }) => {
    ...
    if (await btnNovo.isVisible()) {
        ...
        if (await isVisible(admissionInputs)) {
