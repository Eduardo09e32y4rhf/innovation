...
async def list_candidates(
    ...
    try:
        ...
        if (
            not company_id and current_user.role != "admin"
        ):  # Permissive for now if admin
        ...
        results = (
            ...
            .join(User, Application.candidate_user_id == User.id)
...
async def get_candidate_profile(
    ...
    try:
        ...
        applications = (
            ...
            .filter(Application.candidate_user_id == candidate_id)
            .all()
        )
