...
ASAAS_API_KEY="<COLE_A_CHAVE_ASAAS_DIRETO_NA_VPS>"
ASAAS_API_URL=https://api-sandbox.asaas.com/v3
ASAAS_WEBHOOK_TOKEN="<GERAR_TOKEN_WEBHOOK_DIRETO_NA_VPS>"
ASAAS_WEBHOOK_URL=https://$DOMAIN/api/finance/webhook/asaas
