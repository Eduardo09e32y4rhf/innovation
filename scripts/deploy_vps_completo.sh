...
DB_PASS="<YOUR_DB_PASSWORD>" # REPLACE WITH ACTUAL DB PASSWORD
...
# Gemini AI
GEMINI_API_KEYS="" # REPLACE WITH ACTUAL KEYS
GEMINI_API_KEY_1="" # REPLACE WITH ACTUAL KEY
GEMINI_API_KEY_2="" # REPLACE WITH ACTUAL KEY
GEMINI_API_KEY_3="" # REPLACE WITH ACTUAL KEY
GEMINI_API_KEY_4="" # REPLACE WITH ACTUAL KEY

# Pagamentos Asaas (sandbox)
ASAAS_API_KEY="" # REPLACE WITH ACTUAL KEY
ASAAS_API_URL=https://sandbox.asaas.com/api/v3
ASAAS_WEBHOOK_TOKEN="" # REPLACE WITH ACTUAL TOKEN
...
NEXT_PUBLIC_GEMINI_API_KEY="" # REPLACE WITH ACTUAL KEY
